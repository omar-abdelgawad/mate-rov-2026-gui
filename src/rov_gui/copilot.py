...
class CopilotUi(object):
    ...
    def setupUi(self, Dialog):
        ...
        # VX
        self.vx_label_design.setGeometry(
            QRect(left_col_x, current_y, vx_design_w, std_height)
        )
        self.vx_label.setGeometry(
            QRect(right_col_x, current_y, value_label_w, std_height)
        )
        current_y += v_spacing_std

        # VY
        self.vy_label_design.setGeometry(
            QRect(left_col_x, current_y, vy_design_w, std_height)
        )
        self.vy_label.setGeometry(
            QRect(right_col_x, current_y, value_label_w, std_height)
        )
        current_y += v_spacing_std

        # WZ
        self.wz_label_design.setGeometry(
            QRect(left_col_x, current_y, wz_design_w, std_height)
        )
        self.wz_label.setGeometry(
            QRect(right_col_x, current_y, value_label_w, std_height)
        )
        current_y += v_spacing_std

        # Roll
        self.roll_label_design.setGeometry(
            QRect(left_col_x, current_y, roll_design_w, std_height)
        )
        ...
        # Pitch
        self.pitch_label_design.setGeometry(
            QRect(left_col_x, current_y, pitch_design_w, std_height)
        )
        self.pitch_label.setGeometry(
            QRect(right_col_x, current_y, value_label_w, std_height)
        )
        current_y += v_spacing_std

        # Actual Yaw (standard height)
        self.actual_yaw_label_design.setGeometry(
            QRect(left_col_x, current_y, yaw_design_w, std_height)
        )  # Use std_height
        self.actual_yaw_label.setGeometry(
            QRect(right_col_x, current_y, value_label_w, std_height)
        )  # Use std_height
        current_y += v_spacing_std  # Use standard spacing

        # Desired Yaw (standard height)
        self.desired_yaw_label_design.setGeometry(
            QRect(left_col_x, current_y, yaw_design_w, std_height)
        )  # Use std_height
        self.desired_yaw_label.setGeometry(
            QRect(right_col_x, current_y, value_label_w, std_height)
        )  # Use std_height
        current_y += v_spacing_std  # Use standard spacing

        # Actual Depth (standard height)
        self.actual_depth_label_design.setGeometry(
            QRect(left_col_x, current_y, depth_design_w, std_height)
        )  # Use std_height
        self.actual_depth_label.setGeometry(
            QRect(right_col_x, current_y, value_label_w, std_height)
        )  # Use std_height
        current_y += v_spacing_std  # Use standard spacing

        # Desired Depth (standard height)
        self.desired_depth_label_design.setGeometry(
            QRect(left_col_x, current_y, depth_design_w, std_height)
        )  # Use std_height
        self.desired_depth_label.setGeometry(
            QRect(right_col_x, current_y, value_label_w, std_height)
        )  # Use std_height

        self.jellyfish_button = QPushButton("Jellyfish", Dialog)
        self.jellyfish_button.setObjectName("Jellyfish Button")
        self.jellyfish_button.setGeometry(
            QRect(scale(800), scale(400), scale(120), scale(41))
        )
        ...
        self.jellyfish_indicator_status.setGeometry(
            QRect(scale(852), scale(450), scale(20), scale(20))
        )
        self.jellyfish_indicator_status.setStyleSheet(
            "background-color: red; border-radius: 10px; border: 2px solid white;"
        )
        ...
        self.indicator1_label.setGeometry(
            QRect(scale(160), scale(400), scale(120), scale(41))
        )
        ...
        self.indicator1_status.setGeometry(
            QRect(scale(290), scale(410), scale(20), scale(20))
        )
        self.indicator1_status.setStyleSheet(
            "background-color: green; border-radius: 10px; border: 2px solid white;"
        )

        self.indicator2_label = QLabel(Dialog)
        self.indicator2_label.setObjectName("Indicator 2 Label")
        self.indicator2_label.setGeometry(
            QRect(scale(160), scale(450), scale(120), scale(41))
        )
        ...
        self.indicator2_status.setGeometry(
            QRect(scale(290), scale(460), scale(20), scale(20))
        )
        self.indicator2_status.setStyleSheet(
            "background-color: green; border-radius: 10px; border: 2px solid white;"
        )

        self.indicator3_label = QLabel(Dialog)
        self.indicator3_label.setObjectName("Indicator 3 Label")
        self.indicator3_label.setGeometry(
            QRect(scale(160), scale(500), scale(120), scale(41))
        )
        ...
        self.indicator3_status.setGeometry(
            QRect(scale(290), scale(510), scale(20), scale(20))
        )
        self.indicator3_status.setStyleSheet(
            "background-color: green; border-radius: 10px; border: 2px solid white;"
        )

        self.indicator4_label = QLabel(Dialog)
        self.indicator4_label.setObjectName("Indicator 4 Label")
        self.indicator4_label.setGeometry(
            QRect(scale(160), scale(550), scale(120), scale(41))
        )
        ...
        self.indicator4_status.setGeometry(
            QRect(scale(290), scale(560), scale(20), scale(20))
        )
        self.indicator4_status.setStyleSheet(
            "background-color: green; border-radius: 10px; border: 2px solid white;"
        )
        ...
        self.reset_button.setGeometry(
            QRect(scale(20), scale(550), scale(120), scale(41))
        )
        ...
        self.command_input.setGeometry(
            QRect(scale(20), scale(650), scale(120), scale(41))
        )
        ...
        self.command_field.setGeometry(
            QRect(scale(150), scale(650), scale(400), scale(41))
        )
        ...
        self.execute_button.setGeometry(
            QRect(scale(570), scale(650), scale(100), scale(41))
        )
        ...
        self.rov_label.setGeometry(
            QRect(scale(400), scale(250), scale(421), scale(291))
        )
        ...
        self.StreamButton.setGeometry(
            QRect(scale(800), scale(149), scale(101), scale(41))
        )
        ...
        self.brightness.setGeometry(
            QRect(scale(300), scale(110), scale(121), scale(41))
        )
        ...
        self.brightness_slider.setGeometry(
            QRect(scale(280), scale(160), scale(160), scale(25))
        )
        ...
        self.apply_brightness.setGeometry(
            QRect(scale(310), scale(200), scale(100), scale(32))
        )
        ...
        self.contrast_slider.setGeometry(
            QRect(scale(450), scale(160), scale(160), scale(25))
        )
        ...
        self.apply_contrast.setGeometry(
            QRect(scale(480), scale(200), scale(100), scale(32))
        )
        ...
        self.backLight_slider.setGeometry(
            QRect(scale(620), scale(160), scale(160), scale(25))
        )
        ...
        self.apply_backlight.setGeometry(
            QRect(scale(660), scale(200), scale(100), scale(32))
        )
    ...
    def apply_backlight_clicked(self):
        ...
        if cam_name != "Select":
            ...
            send_command(
                self.client, CAM_PORTS[cam_name], "backlight_compensation", value
            )
    ...
    def setText(self, Dialog):
        ...
        self.roll_label_design.setText(
            QCoreApplication.translate("Dialog", "Roll", None)
        )
        self.pitch_label_design.setText(
            QCoreApplication.translate("Dialog", "Pitch", None)
        )
        self.actual_yaw_label_design.setText(
            QCoreApplication.translate("Dialog", "Actual Yaw ", None)
        )
        self.desired_yaw_label_design.setText(
            QCoreApplication.translate("Dialog", "Desired Yaw ", None)
        )
        self.actual_depth_label_design.setText(
            QCoreApplication.translate("Dialog", "Actual Depth ", None)
        )
        self.desired_depth_label_design.setText(
            QCoreApplication.translate("Dialog", "Desired Depth ", None)
        )
        ...
        self.actual_depth_label.setText(
            QCoreApplication.translate("Dialog", "...", None)
        )
        self.desired_yaw_label.setText(
            QCoreApplication.translate("Dialog", "...", None)
        )
        self.desired_depth_label.setText(
            QCoreApplication.translate("Dialog", "...", None)
        )
        ...
        self.CAS.setText(
            QCoreApplication.translate("Dialog", "Camera Adjusting System", None)
        )
        self.brightness.setText(
            QCoreApplication.translate("Dialog", "Brightness", None)
        )
        ...
        self.comboBox.setItemText(
            5, QCoreApplication.translate("Dialog", "Jelly", None)
        )
    ...
    def update_angles(self, angles_msg):
        """
    ...
    def update_actual_depth(self, depth):
        """
